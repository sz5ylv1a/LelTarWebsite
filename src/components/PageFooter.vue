...
<template>
	<footer class="bg-body-tertiary px-3 py-3 mt-auto border-top border-body">
		<div class="container-xxl">
			<div class="d-flex">
				<div class="flex-fill text-start">
					<p class="mb-0">&#x1f12f; {{ entityName }} {{ fYear }}-{{ lYear }}. Game licensed under <a href="https://www.mozilla.org/en-US/MPL/2.0/">MPL-2.0</a>, website <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/">CC BY-NC-SA 4.0</a></p>
				</div>
