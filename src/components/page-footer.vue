		...
		<div class="container-xxl">
			<div class="d-flex">
				<div class="flex-fill text-start">
					<p class="mb-0"><span class="copyleft">&copy;</span> {{ entityName }} {{ fYear }}-{{ lYear }}. Game licensed under <a href="">MPL-2.0</a>, website <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/">CC BY-NC-SA 4.0</a></p>
				</div>
