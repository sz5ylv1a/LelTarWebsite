<template>
	<div class="container-xxl">
		...
		<h2 id="backstory"><i class="bi bi-hourglass-split" /><span>Backstory / Prologue</span></h2>
		...
		<h2 id="controls"><i class="bi bi-joystick" /><span>Controls</span></h2>
		...
		<p>This game was made using <strong><a href="https://godotengine.org/download/archive/#4.7.2" target="_blank">Godot Engine 4.7.2</a></strong> using the <strong>GDScript</strong> language. It supports native <strong>Vulkan</strong> rendering, with fallbacks for <strong>DirectX 12</strong> and <strong>OpenGL 3</strong> if not supported by the hardware.</p>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col">
					<h4><i class="bi bi-slash-circle" /><span>Minimum</span></h4>
					<ul>
						<li><b>Operating System *:</b> Windows 10 or newer</li>
						<li><b>CPU:</b></li>
						<ul>
							<li>x64 CPU with SSE4.2</li>
							<li>ARMv8 CPU or newer ABI</li>
						</ul>
						<li><b>RAM:</b> 4 GB</li>
						<li><b>GPU:</b> Support for OpenGL 3.3</li>
						<li><b>Storage:</b> 150 MB of free space</li>
					</ul>
				</div>
				<div class="col">
					<h4><i class="bi bi-check-circle" /><span>Recommended</span></h4>
					<ul>
						<li><b>Operating System *:</b> Windows 10 or newer</li>
						<li><b>CPU:</b></li>
						<ul>
							<li>Intel&reg; Core&trade; i7-3770 <em>(or equivalent/newer)</em></li>
							<li>Snapdragon X Elite <em>(or newer)</em></li>
						</ul>
						<li><b>RAM:</b> 8 GB</li>
						<li><b>GPU:</b> Support for Vulkan 1.2 and/or DirectX 12</li>
						<li><b>Storage:</b> 250 MB of free space or more</li>
					</ul>
				</div>
			</div>
			<div class="row text-secondary">
				<span>* The operating system section only applies to Windows users, Linux and Mac users don't need to worry about this section regardless of architecture.</span>
				<span>If you're trying to run the Windows ARM64 build, only Windows 11 seems to be supported.</span>
			</div>
		</div>
	</div>
</template>
