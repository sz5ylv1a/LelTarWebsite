...
<template>
	<div class="container-xxl">
		...
		<h2 id="controls"><i class="bi bi-joystick"></i> Controls</h2>
		...
		<h2 id="technical-details"><i class="bi bi-tools"></i> Technical details</h2>
		...
		<h3 id="system-requirements"><i class="bi bi-pc-display"></i> System requirements</h3>
		<div class="container-fluid">
			<div class="row">
				<div class="col">
					<h4><i class="bi bi-slash-circle"></i> Minimum</h4>
					<ul>
						<li><b>OS:</b> Windows 10 <em>(or equivalent Linux and/or Wine version)</em></li>
						<li><b>CPU:</b> x86_64 CPU with SSE4.2 support</li>
						<li><b>RAM:</b> 4 GB</li>
						<li><b>GPU:</b> Support for OpenGL 3.3 <em>(or newer/equivalent)</em></li>
						<li><b>Storage:</b> 150 MB of free space</li>
					</ul>
				</div>
				<div class="col">
					<h4><i class="bi bi-check-circle"></i> Recommended</h4>
					<ul>
						<li><b>OS:</b> Windows 10 <em>(or equivalent Linux and/or Wine version)</em></li>
						<li><b>CPU:</b> Intel&reg; Core&trade; i7-3770 <em>(or equivalent)</em></li>
						<li><b>RAM:</b> 8 GB</li>
						<li><b>GPU:</b> Support for Vulkan 1.2 <em>(or newer)</em></li>
